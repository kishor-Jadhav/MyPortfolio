...
const MyResume = () => {
     return (
        <>
          ...
          <div className="min-h-screen bg-gray-200 py-10 px-12">
            <MyResumeNavbar />
          <div className="max-w-7xl mx-auto bg-white shadow-2xl grid md:grid-cols-[320px_1fr] overflow-hidden">
            ...
            {/* RIGHT CONTENT */}
            <div className="p-10 md:p-14 text-gray-800">
